    ...
    enemiesWaveParmeter() {
        ...
        this.waveParameters = [
            ...
            },
            {
                ...
                delayBetweenSteps: 100, // in ms,
                enemyBehavior: [
                    {
                        type: `virus_4`,
                        total: 5,
                        startPosition: new THREE.Vector3(randomXPos(5), maxY, params.elementZIndex),
                        path: [...generatePath(6, 5)],
                    },
                    {
                        type: `virus_5`,
                        total: 5,
            ...
            },
            {
                ...
                enemyBehavior: [
                    ...
                    },
                    {
                        ...
                        total: 5,
                        startPosition: new THREE.Vector3(randomXPos(5), maxY, params.elementZIndex),
                        path: [...generatePath(5, 5)],
                    },
                    {
                        type: `virus_2`,
                        total: 5,
                        startPosition: new THREE.Vector3(randomXPos(5), maxY, params.elementZIndex),
                        path: [...generatePath(7, 5)],
                    },
                    {
                        type: `virus_7`,
                        total: 5,
